...
function randomString(){
    ...
    $tmp = "";
    $inputString = "abcdefghijklmnopqrstuvwxyz1234567890";
    ...
    <div class="wrapper">
        <form action="<?= $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
            ...
            <div>
                ...
                <p>
                    <input type="text" name="area" value="" placeholder="地区">
                </p>
                <p>
                    <input type="text" name="prefecture" value="" placeholder="開催県">
                </p>
                <p>
                    <input type="text" name="place" value="" placeholder="開催地">
                </p>
                <p>
                    <input type="text" name="date" value="" placeholder="開催日">
                </p>
                <p>
                    <input type="text" name="date_sub" value="" placeholder="開催日時の注意書き">
                </p>
                <p>
                ...
                <p>
                    <input type="text" name="parking" value="" placeholder="駐車場について">
                </p>
                <p>
            ...
            <div>
                ...
                <p>
                    <span class="area <?= $area_hide ?>"><?= $area ?></span>
                    <input type="hidden" name="area" value="<?= $area ?>" placeholder="地区">
                </p>
                <p>
